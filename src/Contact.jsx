...
const Contact=()=> {
  ...
  const formSubmit =(e)=>{
    e.preventDefault();
    alert(` Thanks ${data.fullname} for your intrest `);
    ...
    <div className='container contact_div'>
      ...
      <form onSubmit={formSubmit}>
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="exampleFormControlInput1" name='phone' value={data.phone} onChange={InputEvent} placeholder="123456789"/>
          </div>
          <div class="mb-3">
